                    ...
                    <form className="flex flex-col gap-5" onSubmit={onHandleSubmit} method="post">
                        ...
                        <div
                            ...
                            <div className="h-full w-full rounded-lg overflow-hidden relative flex items-center justify-center">
                                {data.preview && <img className={'w-full object-contain'} src={data.preview} alt={data.alt ?? ''}/>}
                                {!data.preview && <div className="w-full h-full bg-gray-200 flex justify-center items-center">No image selected</div>}
                            </div>
